...
import 'package:flutter_api_workshop/presentation/widgets/book_details_cover_image.dart';
import 'package:flutter_api_workshop/presentation/widgets/book_details_description.dart';
import 'package:flutter_api_workshop/presentation/widgets/book_details_main_info.dart';
import 'package:flutter_api_workshop/presentation/widgets/book_details_numbers_segment.dart';
        ...
        if (book == null) {
          ...
          child = CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(child: BookDetailsMainInfo(book: book)),
              SliverToBoxAdapter(child: BookDetailsNumbersSegment(book: book)),
              SliverToBoxAdapter(
                child: BookDetailsDescription(description: book.description),
              ),
            ],
          );
        }
