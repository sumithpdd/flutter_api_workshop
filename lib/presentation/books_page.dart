...
import 'package:flutter_api_workshop/presentation/book_details_page.dart';
import 'package:flutter_api_workshop/presentation/widgets/book_list_item.dart';
import 'package:flutter_api_workshop/presentation/fave_books_page.dart';

class BooksPage extends StatefulWidget {
  final BooksRepository booksRepository;

  const BooksPage({super.key, required this.booksRepository});
        ...
        title: Container(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.search, color: AppTheme.grayDark),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) =>
                  FaveBooksPage(booksRepository: widget.booksRepository),
            ),
          );
        },
